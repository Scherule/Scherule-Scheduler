...
internal class AvailabilityTest {
    ...
    fun onlyWithinNarrowsNonOverlappingIntervals() {
        assertThat(Availability(setOf(Interval.parse("2017-10-01T14:15Z/2017-10-05T19:00Z")))
                .onlyWithin(Interval.parse("2017-10-02T14:15Z/2017-10-05T16:00Z")))
                .isEqualTo(Availability(setOf(Interval.parse("2017-10-02T14:15Z/2017-10-05T16:00Z"))))
    }

    @Test
    fun filtersOutIntervalsOutsideBetweenInterval() {
        assertThat(Availability(setOf(
